...
<!--main_navbar.php-->
	...
	<?php if(array_key_exists("app.produce", $_ENV)) :?>
		<script src="<?php echo site_furl('/assets/js/bsresult_edit-script.js?t='.time());?>"></script>
	<?php else : ?>
		<script src="<?php echo site_furl('/assets/js/bsresult_edit-script.js?v=1');?>"></script>
	<?php endif ?>
<?= $this->endSection() ?>