	...
	<div class="confsite-site-panel">
		...
		<div class="confsite-site-text-div">
			<textarea rows="8" id="confsite-deposite-text-id"><?php if(!is_null($arrConfig)) {  ?><?=$arrConfig[5]['conf_content']?><?php } ?></textarea>			
		</div>

		<!---->
		<h4><i class="glyphicon glyphicon-hand-right"></i> 출금안내</h4>				
		<div class="confsite-site-text-div">
			<textarea rows="8" id="confsite-withdraw-text-id"><?php if(!is_null($arrConfig)) {  ?><?=$arrConfig[6]['conf_content']?><?php } ?></textarea>					
		</div>

		<!---->
		<h4><i class="glyphicon glyphicon-hand-right"></i> 계좌문의 매크로</h4>				
		<div class="confsite-site-text-div">
			<textarea rows="8" id="confsite-bankmacro-text-id"><?php if(!is_null($arrConfig)) {  ?><?=$arrConfig[8]['conf_content']?><?php } ?></textarea>					
		</div>
