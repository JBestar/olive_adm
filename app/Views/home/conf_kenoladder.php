...
<!--Sub Navbar-->
	<div class = "sub-navbar">
		...
		<a href="<?php echo base_url().'home/conf_kenoladder';?>" class="sub-navbar-a active" >키노사다리</a>
	...
	<div class="confsite-game-panel">
		<!---->
		<h4><i class="glyphicon glyphicon-hand-right"></i> 키노사다리 게임관련 설정</h4>	
...
<script src="<?php echo base_url('assets/js/confks-script.js');?>"></script>
<?= $this->endSection() ?>