...
<?= $this->section('content') ?>
	...
	<div class = "sub-navbar">
		...
		<a href="<?php echo base_url().'bet/bbcalculate';?>" class="sub-navbar-a active" >보글볼</a>
	...
	<div class="bet-panel">
		...
		<div class="pbresult-list-div">
            ...
            <label> ~ </label>
            <input type="date" id="calculate-dateend-input-id" value="<?php echo date('Y-m-d'); ?>"s>
...
<script src="<?php echo base_url('assets/js/bbcalculate-script.js');?>"></script>
<?= $this->endSection() ?>