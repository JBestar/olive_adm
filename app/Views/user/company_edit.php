...
<!--Sub Navbar-->
	...
	<?php } else {?>
		<p ><i class="glyphicon glyphicon-user"></i> 회원관리::부본사 수정</p>
	<?php } ?>
	...
	<div class="useredit-panel">
		...
		<div class="useredit-percent-div">
			...
			<label> 배당율(%)</label>
			<?php if(is_null($objMember)) {  ?>
			<input type = "number" min="0" step="0.1" id="useredit-pbbetrate-input-id" value="0" >
			<?php } else {?>
			<input type = "number" min="0" step="0.1" id="useredit-pbbetrate-input-id" value="<?=$objMember->mb_game_pb_ratio?>">
			<?php } ?>

			<label> 누르기율(%)</label>
			<?php if(is_null($objMember)) {  ?>
			<input type = "number" min="0" step="1" id="useredit-pbbetpercent-input-id" value="100">
			<?php } else {?>
			<input type = "number" min="0" step="1" id="useredit-pbbetpercent-input-id" value="<?=$objMember->mb_game_pb_percent?>">
			<?php } ?>
		</div>
		<div class="useredit-percent-div">
			<p>파워볼조합:</p> 
			...
			<label> 배당율(%)</label>
			<?php if(is_null($objMember)) {  ?>
			<input type = "number" min="0" step="0.1" id="useredit-pbbetrate2-input-id" value="0">
			<?php } else {?>
			<input type = "number" min="0" step="0.1" id="useredit-pbbetrate2-input-id" value="<?=$objMember->mb_game_pb2_ratio?>">
			<?php } ?>

			<label> 누르기율(%)</label>
			<?php if(is_null($objMember)) {  ?>
			<input type = "number" min="0" step="1" id="useredit-pbbetpercent2-input-id" value="100">
			<?php } else {?>
			<input type = "number" min="0" step="1" id="useredit-pbbetpercent2-input-id" value="<?=$objMember->mb_game_pb2_percent?>">
			<?php } ?>
		</div>
		<div class="useredit-percent-div">
			<p>파워사다리:</p> 
			<label> 배당율(%)</label>
			<?php if(is_null($objMember)) {  ?>
			<input type = "number" min="0" step="0.1" id="useredit-psbetrate-input-id" value="0">
			<?php } else {?>
			<input type = "number" min="0" step="0.1" id="useredit-psbetrate-input-id" value="<?=$objMember->mb_game_ps_ratio?>">
			<?php } ?>

			<label> 누르기율(%)</label>
			<?php if(is_null($objMember)) {  ?>
			<input type = "number" min="0" step="1" id="useredit-psbetpercent-input-id" value="100">
			<?php } else {?>
			<input type = "number" min="0" step="1" id="useredit-psbetpercent-input-id" value="<?=$objMember->mb_game_ps_percent?>">
			<?php } ?>
		</div>
		<div class="useredit-percent-div">
			<p>키노사다리:</p>			 
			...
			<label> 배당율(%)</label>
			<?php if(is_null($objMember)) {  ?>
			<input type = "number" min="0" step="0.1" id="useredit-ksbetrate-input-id" value="0" >
			<?php } else {?>
			<input type = "number" min="0" step="0.1" id="useredit-ksbetrate-input-id" value="<?=$objMember->mb_game_ks_ratio?>">
			<?php } ?>

			<label> 누르기율(%)</label>
			<?php if(is_null($objMember)) {  ?>
			<input type = "number" min="0" step="1" id="useredit-ksbetpercent-input-id" value="100">
			<?php } else {?>
			<input type = "number" min="0" step="1" id="useredit-ksbetpercent-input-id" value="<?=$objMember->mb_game_ks_percent?>">
			<?php } ?>	
		</div>	
		<div class="useredit-percent-div">
			<p>보글볼단폴:</p> 
