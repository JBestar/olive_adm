	...
	<div class = "sub-navbar">
		<?php if(is_null($objMember)) {  ?>
			<p><i class="glyphicon glyphicon-user"></i> 회원관리::매장 등록</p>
		<?php } else {?>
			<p><i class="glyphicon glyphicon-user"></i> 회원관리::매장 수정</p>
		<?php } ?>
...
<script src="<?php echo base_url('assets/js/employee_edit-script.js?v=1');?>"></script>
