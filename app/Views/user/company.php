...
<?= $this->section('content') ?>
	...
	<div class = "sub-navbar">
		<p><i class="glyphicon glyphicon-user"></i> 회원관리::부본사</p>
	</div>
	<!--Site Setting-->
	<div class="user-panel">
		...
		<Table class="user-table" id="user-company-table-id">
			...
			<tbody>
			<?php $i=1; foreach ($arrCompany as $objMember):?>
			...
			<?php } ?>
				...
				<td>
					...
					<?php } ?>
					<a href="<?php echo base_url().'user/company_edit/'.$objMember->mb_fid;?>" >수정</a>
					<?php if($mb_level >= LEVEL_ADMIN) {  ?>
...
<script src="<?php echo base_url('assets/js/company-script.js?v=1');?>"></script>
<?= $this->endSection() ?>